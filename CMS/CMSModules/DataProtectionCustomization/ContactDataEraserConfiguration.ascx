<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ContactDataEraserConfiguration.ascx.cs" Inherits="CMSApp.CMSModules.DataProtectionCustomization.ContactDataEraserConfiguration" %>
