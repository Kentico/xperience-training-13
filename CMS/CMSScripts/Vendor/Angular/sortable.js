      ...
      return {
        ...
        link: function(scope, element, attrs, ngModel) {
          var savedNodes;
		   ...
		   /** CMS customization start - cms jquery is in custom global variable so reference has to be added manually **/
            element = $cmsj(element);
            element.sortable = $cmsj.prototype.sortable;
            /** CMS customization end **/
          ...
          angular.extend(opts, directiveOpts, uiSortableConfig, scope.uiSortable);
           ...
           /** CMS customization start - jquery was already loaded (see previous customization), it does not have to be checked **/
