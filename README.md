...
The code in the current branch represents the final state of development of the **Identity** module of the [Kentico Xperience for developers](https://xperience.io/services/training/xperience-for-developers) course.
