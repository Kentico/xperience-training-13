...
The code in the current branch serves as a starting point for the exercises in the **Email marketing** module of the [Kentico Xperience marketing for developers](https://xperience.io/services/training/xperience-marketing-for-developers) course.
